...
const nodes: NodeData[] = [
  {
    ...
    minioFeature: 'MinIO AIStor: 165 GiB/s PUT (32-node), 2.5 TiB/s aggregate (300-server). Whitepaper: disaggregated architecture enables independent compute/storage scaling',
    dataVolume: 'PB',
    phase: 1,
  },
  {
  ...
  },
  {
    ...
    minioFeature: 'MinIO Cache: distributed shared DRAM cache prevents GPU starvation. Whitepaper: 325 GiB/s GET on 32-node cluster; 46.5 GB/s on 8-node',
    dataVolume: 'GB/s',
    phase: 2,
  },
  {
